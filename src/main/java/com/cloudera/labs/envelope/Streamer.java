...
import com.cloudera.labs.envelope.source.QueueSource;
import com.cloudera.labs.envelope.utils.PropertiesUtils;
import com.cloudera.labs.envelope.utils.SparkSQLAvroUtils;
import com.google.common.collect.Maps;

/**
 * The entry point into Envelope. Configures the Apache Spark Streaming job and runs it indefinitely.
 */
...
{   
    ...
    private static SparkConf getSparkConfiguration(Properties props) {
        ...
        // Rate limit the micro-batches when using Apache Kafka to 5000 records per Kafka topic partition
